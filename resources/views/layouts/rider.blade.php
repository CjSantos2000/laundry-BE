...
<body>
    <div id="wrapper">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="{{ route('riders.account.change-password') }}">Change Password</a></li>
                            <li>
                                <form method="POST" action="{{ route('riders.logout') }}">
                                    @csrf
        ...
        <nav id="column-left">
            <ul id="menu">
                <li><a href="{{ route('riders.dashboard.index') }}"><i class="fa-solid fa-gauge"></i> Dashboard</a></li>
                <li><a href="{{ route('riders.ride-histories.index') }}"><i class="fa-solid fa-car"></i> Ride Histories</a></li>
            </ul>
        </nav>
        <div id="content">
            @yield('content')
